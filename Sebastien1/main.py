...
while True:
    ...
    #aruco_in_robotic_coords = get_l_manup_cords(mm_coord_right_robot_battery);print('auco in robot coords: ',mm_coord_right_robot_battery)
    ...
    if right_robot_battery is not [[6*None]]:
        rx, ry, rz = angle_gripper(right_robot_battery[0][1])
    ...
    '''
    manipulator1 = Manipulator(ROBOT1["ip"], ROBOT1['acel'],ROBOT2['speed'])
    manipulator2 = Manipulator(ROBOT2["ip"], ROBOT2['acel'],ROBOT2['speed'])
    controller = Manipulator_Controller(manipulator1,manipulator2)
