...
class Visualize:
    ...
    def add_border(self) -> None:
        self.image = cv2.copyMakeBorder(src=self.image, top=self.border_size, bottom=self.border_size,
                                        left=self.border_size, right=self.border_size, borderType=cv2.BORDER_CONSTANT,
                                        value=(184, 184, 184))
    ...
    def draw_battery(self, charged_up: bool, charged_down: bool, discharged_up: bool, discharged_down: bool) -> None:
        cv2.rectangle(self.image, (10, 140), (80, 210), (0, 255, 0) if discharged_up else (0, 0, 255),10)
        cv2.rectangle(self.image, (10, 270), (80, 340), (0, 255, 0) if discharged_down else (0, 0, 255), 10)
        cv2.rectangle(self.image, (550, 140), (620, 210), (0, 255, 0) if charged_up else (0, 0, 255), 10)
        cv2.rectangle(self.image, (550, 270), (620, 340), (0, 255, 0) if charged_down else (0, 0, 255), 10)
